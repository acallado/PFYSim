...
parser.add_argument(
    '-igc',
    help='Number of ingates',
    type=int)
parser.add_argument(
    '-ogc',
    help='Number of outgates',
    type=int)
parser.add_argument(
    '-tnc',
    help='Train well count',
    type=int)
parser.add_argument(
    '-tcl',
    help='Car well length',
    type=float)
parser.add_argument(
    '-pfw',
    help='PFinder width',
...
ingates_capacity = int(args.igc)
outgates_capacity = int(args.ogc)
train_car_count = int(args.tnc)
train_car_length = float(args.tcl)
pfinder_width = float(args.pfw)
...
class Truck(object):
    ...
    def run(self):
        ...
        with ingates.request() as req:
            ...
            self.ingate_process_time = numpy.random.normal(0.5, 0.05)
        ...
        with outgates.request() as req:
            yield req
            self.outgate_process_time = numpy.random.normal(0.5, 0.05)
